                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('profile.update.password') }}" class="mt-4">
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="current_password" type="text" class="form-control @error('current_password') is-invalid @enderror" name="current_password" value="{{ old('current_password', $user->password) }}" required>
